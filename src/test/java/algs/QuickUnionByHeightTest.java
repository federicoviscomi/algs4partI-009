...
public class QuickUnionByHeightTest {

    @Test
    public void testQuickUnionGetMaxDepth() {
        QuickUnionByHeight uf = new QuickUnionByHeight(8);
        int[][] input = new int[][]{
                new int[]{0, 1},
                new int[]{2, 3},
                new int[]{4, 5},
    ...
    public void testQuickUnion() {
        QuickUnionByHeight uf = new QuickUnionByHeight(10);
        int[][] input = new int[][]{
                new int[]{4, 3},
                new int[]{3, 8},
                new int[]{6, 5},
    ...
    public void testEmptyAllNotConnected() {
        QuickUnionByHeight qf = new QuickUnionByHeight(10);

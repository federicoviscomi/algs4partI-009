...
class QuickUnionSimpleOnePassPathCompression {
    ...
    public QuickUnionSimpleOnePassPathCompression(int n) {
        if (n < 0) {
    ...
    public String toString() {
        ...
        stringBuilder.append(QuickUnionSimpleOnePassPathCompression.class.getCanonicalName());
